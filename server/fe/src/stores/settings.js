...
export const settingsStore = defineStore("settings", {
    ...
    actions: {
        async fetchSettings() {
            try {
                const data = await axios.get('http://localhost:4000/api/setting')
                ...
                const problems = await axios.get('http://localhost:4000/api/problem')
                this.problems = problems.data

                const hosts = await axios.get('http://localhost:4000/api/host')
